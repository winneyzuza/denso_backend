    ...
    <head>
        ...
        <script>
            $(document).on('change', '#CarMaker', function(){
                ...
                $("#results").html('');
                $.ajax({
                    url:        '<?PHP echo base_url(); ?>index.php/search/fetchacarmodel',
            ...
            $(document).on('change', '#CarModel', function(){
                $("#results").html('');
                $.ajax({
                    url:        '<?PHP echo base_url(); ?>index.php/search/fetchaenginemodel',
            ...
            $(document).on('change', '#EngineModel', function(){
                $.ajax({
                    url:        '<?PHP echo base_url(); ?>index.php/search/fetcharesults',
                ...
                .done(function(data){
                    ...
                    $.each(data.result, function(key, value){
                        results += "<tr>\n\
                            <td><a href='<?PHP echo base_url(); ?>index.php/update/alternator/" + value.id + "'>" + value.id + "</a></td>\n\
