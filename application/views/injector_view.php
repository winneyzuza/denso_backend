...
//            print_r($raw);
    ...
    <script>
        $(document).on('change', '#CarMaker', function(){
            ...
            $("#results").html('');
            $.ajax({
                url:        '<?PHP echo base_url(); ?>index.php/search/fetchinjcarmodel',
        ...
        $(document).on('change', '#CarModel', function(){
            $("#results").html('');
            $.ajax({
                url:        '<?PHP echo base_url(); ?>index.php/search/fetchinjenginemodel',
        ...
        $(document).on('change', '#EngineModel', function(){
            $.ajax({
                url:        '<?PHP echo base_url(); ?>index.php/search/fetchinjresults',
            ...
            .done(function(data){
                ...
                $.each(data.result, function(key, value){
                    results += "<tr>\n\
                        <td><a href='<?PHP echo base_url(); ?>index.php/update/injector/" + value.id + "'>" + value.id + "</a></td>\n\
