...
<div>
    <div class="outer center">
        <!--span class="bordersolid floatleft" style="padding: 10px;">โลโก้</span--><span>แบบฟอร์มขอแลกเปลี่ยนปั๊มน้ำมันเชื้อเพลิงและหัวฉีดไฟฟ้าสำหรับ (<?php echo ($this->input->get('CarMaker'))?$this->input->get('CarMaker'):'ชื่อยี่ห้อรถ'; ?>)</span><span class="denso">DENSO</span>
    </div>
    <br /><br />
    <table class="bordersolid outer">
        <tr>
            ...
            <td colspan="3" class="bordersolidleft bold">ชื่อตัวแทนจำหน่ายรถยนต์ (<?php echo $this->input->get('CarMaker'); ?>)</td>
