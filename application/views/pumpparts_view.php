    ...
    <head>
        ...
        <script>
            $(document).on('change', '#CarMaker', function(){
                ...
                $("#results").html('');
                $.ajax({
                    url:        '<?PHP echo base_url(); ?>index.php/search/fetchcarmodel',
            ...
            $(document).on('change', '#CarModel', function(){
                $("#results").html('');
                $.ajax({
                    url:        '<?PHP echo base_url(); ?>index.php/search/fetchenginemodel',
            ...
            $(document).on('change', '#EngineModel', function(){
                $.ajax({
                    url:        '<?PHP echo base_url(); ?>index.php/search/fetchresults',
                ...
                .done(function(data){
                    ...
                    $.each(data.result, function(key, value){
                        results += "<tr>\n\
                            <td><a href='<?PHP echo base_url(); ?>index.php/update/pumpparts/" + value.id + "'>" + value.id + "</a></td>\n\
