...
<div>
    <div class="outer center formtitle fixedfont" >
        ...
        <span style="display: inline-block; vertical-align: middle;"><h3>แบบฟอร์มขอแลกเปลี่ยนคอมเพรสเซอร์สำหรับ (TOYOTA)</h3></span>
...
<!--            <td colspan="2" class="bordersolidright"><?php echo isset($sd_info[lang('create_sd_name')])?$sd_info[lang('create_sd_name')]:'____________________'; ?></td>-->
    ...
    <table class="bordersolid outer fixedfont">
        ...
        <tr class="bordersolid">
            <td  colspan="2"><b>คอมเพรสเซอร์</b> &nbsp;&nbsp;จำนวน&nbsp;&nbsp;&nbsp;
                <?php echo ($this->input->get('part_id'))?'1':'__________' ?>&nbsp;&nbsp;ตัว</td>
            <td colspan="2" >ชนิดคอมเพรสเซอร์&nbsp;&nbsp;&nbsp;
                <?php echo ($this->input->get("compressor_type"))?$this->input->get("compressor_type"):"__________"; ?>
            </td>
        </tr>
        <tr class="bordersolid">
            <td colspan="2">หมายเลขอะไหล่ &nbsp;&nbsp;<?php echo ($this->input->get('part_failure_pn') && intval($this->input->get('part_id')) === 3)?$this->input->get('part_failure_pn'):'__________' ?></td>
            <td colspan="2">หมายเลขการผลิต &nbsp;&nbsp;<?php echo ($this->input->get('failure_sn_1') && intval($this->input->get('part_id')) === 3)?$this->input->get('failure_sn_1'):'__________' ?></td>
        ...
        <tr>
            <td>
                <table class="bordersolid fixedfont" width ="150px">
                    ...
                    <tr>
                        <td>1</td>
                        <td><input type="checkbox" <?PHP if($this->input->get('car_problem') == '26') echo "checked"; ?>/></td>
                        <td>ชุดคลัชท์ดัง</td>
                    </tr>
                    <tr class="borderdottedtop">
                        <td>2</td>
                        <td><input type="checkbox" <?PHP if($this->input->get('car_problem') == '27') echo "checked"; ?>/></td>
                        <td>คลัชท์เสีย</td>
                    </tr>
                    <tr class="borderdottedtop">
                        <td>3</td>
                        <td><input type="checkbox" <?PHP if($this->input->get('car_problem') == '28') echo "checked"; ?>/></td>
                        <td>ภายในคอมฯดัง</td>    
                    <tr class="borderdottedtop">
                        <td>4</td>
                        <td><input type="checkbox" <?PHP if($this->input->get('car_problem') == '29') echo "checked"; ?>/></td>
                        <td>ไม่มีแรงดูด-อัด</td>
                    </tr>
                    <tr class="borderdottedtop">
                        <td>5</td>
                        <td><input type="checkbox" <?PHP if($this->input->get('car_problem') == '30') echo "checked"; ?>/></td>
                        <td>รั่ว</td>
                    </tr>
                    <tr class="borderdottedtop">
                        <td>6</td>
                        <td><input type="checkbox" <?PHP if($this->input->get('car_problem') == '31') echo "checked"; ?>/></td>
            ...
            <td valign="top">
                <table class="fixedfont" style="width: 600px; float: right;">
                    ...
                    <tr>
                        <td colspan="6"class="bordersolid">1 ศูนย์คอมเพรสเซอร์ &nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($this->input->get('compressor_repair_name'))?$this->input->get('compressor_repair_name'):'__________' ?></td>
                    ...
                    <tr>
                        <td colspan="6">
                            1. ถ้ามีการเปลี่ยนคอมเพรสเซอร์ใหม่ทุกครั้งไม่ว่ากรณีใดๆ ต้องทำการล้างระบบทั้งหมดทุกครั้ง<br/>
                            2. ก่อนติดตั้งคอมเพรสเซอร์ใหม่ทุกครั้ง ให้ทำการหมุนคอมเพรสเซอร์ เพื่อเช็คความผิดปกติ และเพื่อให้น้ำมันคอมเพรสเซอร์ได้ไหลเวียนหล่อลื่นไปยังชิ้นส่วนต่างๆในคอมเพรสเซอร์ <br/>
                            3. ถ้าคอมเพรสเซอร์ล็อคหรือดัง ต้องล้างระบบทั้งหมดหรือถ้าไม่สามารถล้างออกได้จากชิ้นส่วนใด ต้องทำการเปลี่ยนอะไหล่ชิ้นส่วนนั้นใหม่ เพื่อป้องกันการเกิดปัญหาซ้ำ
                        </td>
                    </tr>
